...
public class RobotContainer {
    ...
    private double MaxSpeed = PancakeConstants.kSpeedAt12Volts.in(MetersPerSecond);
    ...
    private double TeleoperatedSpeed = Math.min(PancakeConstants.kSpeedInTeleop.in(MetersPerSecond), MaxSpeed);
    ...
    public final CommandSwerveDrivetrain drivetrain = PancakeConstants.createDrivetrain();
