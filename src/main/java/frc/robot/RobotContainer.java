...
import frc.robot.sim.JoystickXYZ;
...
public class RobotContainer {
    ...
    /** Processed joystick inputs (deadband, smoothing, sim correction). */
    private final JoystickXYZ m_joystickXYZ;
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
            drivetrain.applyRequest(() -> {
                JoystickInputsRecord joy = m_joystickXYZ.getJoystickInputs();
                double leftX = joy.driveX();
                double leftY = joy.driveY();
                double rightX = joy.rotatetX();
