...
public class RobotContainer {
    ...
    /** The drivetrain subsystem, initialized using the drivetrain. */
    public final VisionSubsystem vision = TunerConstants.createVision(drivetrain);
    ...
    private void configureBindings() {
        ...
        vision.setDefaultCommand(
            new VisionDefaultCommand(vision)
        );
