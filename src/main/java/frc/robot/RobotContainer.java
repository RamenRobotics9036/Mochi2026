...
public class RobotContainer {
    ...
    private double getDriveX() {
        ...
        double input = MathUtil.applyDeadband(-driveController.getLeftY(), 0.1);
    ...
    private double getDriveY() {
        ...
        double input = MathUtil.applyDeadband(-driveController.getLeftX(), 0.1);
        double inputScale = driveController.rightBumper().getAsBoolean() ? 0.5 : 1.0;
        return input * TeleoperatedSpeed * inputScale;
    }
    ...
    private double getDriveRotate() {
        ...
        double input = MathUtil.applyDeadband(-driveController.getRightX(), 0.1);
        double inputScale = driveController.rightBumper().getAsBoolean() ? 0.5 : 1.0;
