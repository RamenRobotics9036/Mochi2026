...
public class GeneratedPancakeConstants {
    ...
    // Sensitivity for manual interruption of CommandSwerveDrivetrain requests
    public static final double kSwerveMoveInterruptionSensitivity = 0.1;
    public static final double kSwerveTurnInterruptionSensitivity = 0.1;
