...
public class TunerConstants {
    ...
    public static final double kSpeedDivisionFactor = 4.0;
    ...
    /**
     * Creates a VisionSubsystem instance.
     * This should only be called once in your robot program,.
     */
    public static VisionSubsystem createVision(CommandSwerveDrivetrain drivetrain) {
