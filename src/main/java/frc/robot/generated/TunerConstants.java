...
public class TunerConstants {
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(3.16);
    //public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(2); //Changed temporailly for testing
