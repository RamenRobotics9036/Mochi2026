...
public class TunerConstants {
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                .withStatorCurrentLimit(Amps.of(Constants.SwerveConstants.kDriveStatorCurrentLimit))
    ...
    public static final CANBus kCANBus = new CANBus(Constants.SwerveConstants.kCANBusName, Constants.SwerveConstants.kCANBusLogPath);

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(10.16);
    ...
    private static final Distance kWheelRadius = Inches.of(3.8976);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.22314453125);
